...
public class DeletarEstabelecimento {
    ...
    public static void show(String message, String title){
        ...
        Scene cenario = new Scene(painel, 390, 120);
        ...
        {
                cadastroEstabelecimento.btnExcluir();
                inicio.close();
        });
        btnSim.setOnKeyPressed(e -> {
            if(btnSim.isFocused() == true && e.getCode() == KeyCode.ENTER){
                cadastroEstabelecimento.btnExcluir();
                inicio.close();
            }
        });
